    ...
    >
      <div className="flex flex-col gap-1">
        ...
        <p className="text-xs font-bold text-text-muted">
          Customise display and interaction settings for better usability.
        </p>
      </div>
      ...
      <div className="clay-surface bg-card p-5 border border-white/60 dark:border-white/5 rounded-2xl shadow-xs flex flex-col gap-3">
        <ToggleRow
          icon="Zap"
          label="Reduce Motion"
          desc="Minimise UI animations and transitions."
        ...
        <ToggleRow
          ...
          desc="Increase colour contrast for text and icons."
        ...
        <ToggleRow
          ...
          desc="Enhanced ARIA labelling and live regions."
