    ...
    >
      ...
      {filtered.length === 0 ? (
        <div className="clay-surface bg-card border-2 border-white/60 rounded-3xl p-10 shadow-floating text-center flex flex-col items-center justify-center gap-4 max-w-md mx-auto my-10">
          ...
          <div className="flex flex-col gap-1">
            <h4 className="text-sm font-black text-text-primary uppercase tracking-wider">No Saved Chats</h4>
            ...
            >
              <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="secondary" className="text-[8px] font-bold py-0.5 px-1.5 bg-warning/10 text-warning border-warning/20 rounded">
                    Bookmarked
                  </Badge>
                </div>
