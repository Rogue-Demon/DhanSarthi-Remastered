...
export const apiClient = {
  ...
  patch: (url, data, options = {}) =>
    apiClient.request(url, { ...options, method: 'PATCH', body: JSON.stringify(data) }),
  post: (url, data, options = {}) =>
    apiClient.request(url, { ...options, method: 'POST', body: JSON.stringify(data) }),
  put: (url, data, options = {}) =>
    apiClient.request(url, { ...options, method: 'PUT', body: JSON.stringify(data) }),
